...
const routeSeo = {
  "/": {
    ...
    description: "Rajratna Web Solutions builds modern websites, full-stack applications, e-commerce platforms and custom digital solutions for businesses.",
  },
  "/services": {
    title: "Web Development Services | Rajratna Web Solutions",
    description: "Explore website development, full-stack applications, e-commerce and digital solutions from Rajratna Web Solutions.",
  },
  "/portfolio": {
    title: "Our Projects | Rajratna Web Solutions",
    description: "Explore real web development projects and digital experiences by Rajratna Web Solutions.",
  },
  "/process": {
    title: "Our Process | Rajratna Web Solutions",
    description: "See how Rajratna Web Solutions discovers, plans, designs, develops, tests and launches web projects.",
  },
  "/about": {
    title: "About Rajratna Web Solutions",
    description: "Learn about Rajratna Web Solutions and our work building responsive websites and custom digital solutions.",
  },
  "/contact": {
    title: "Contact Rajratna Web Solutions",
    description: "Contact Rajratna Web Solutions to discuss a website, web application or digital project.",
  },
  "/technologies": {
    title: "Technologies | Rajratna Web Solutions",
    description: "See the web technologies used by Rajratna Web Solutions to build websites and applications.",
  },
  "/privacy": {
    title: "Privacy Policy | Rajratna Web Solutions",
    description: "Read how Rajratna Web Solutions uses information submitted through the website contact form.",
  },
  "/terms": {
...
function applyRouteMetadata(pathname, settings = {}) {
  ...
  const pageSettings = (settings.pageSeo || []).find((item) => item.pageKey === routeKey) || {};
  const hasCustomHomeTitle = savedHomeTitle && savedHomeTitle.toLowerCase() !== "rajratna web solutions";
  const hasCustomHomeDescription = savedHomeDescription && !savedHomeDescription.toLowerCase().startsWith("website design & development");
  const title = isAdmin
    ? adminRouteTitles[path]
      ? `${adminRouteTitles[path]} | Rajratna Web Solutions`
      : "Page Not Found | Rajratna Web Solutions"
    : pageSettings.title || (path === "/" ? hasCustomHomeTitle ? savedHomeTitle : routeSeo["/"].title : page?.title || "Page Not Found | Rajratna Web Solutions");
  const description = pageSettings.description || (path === "/" ? hasCustomHomeDescription ? savedHomeDescription : routeSeo["/"].description : page?.description || "The requested page could not be found on Rajratna Web Solutions.");
  const canonicalUrl = page ? pageSettings.canonicalUrl || `https://rajratna-web-solutions.vercel.app${path === "/" ? "/" : path}` : "";
  const ogTitle = pageSettings.ogTitle || settings.ogTitle || title;
  const ogDescription = pageSettings.ogDescription || settings.ogDescription || (path === "/" ? "Modern websites, full-stack applications and digital solutions by Rajratna Web Solutions." : description);
  ...
  const twitterCard = pageSettings.twitterCard === "summary_large_image" ? "summary_large_image" : "summary";

  document.title = title;
  setMeta('meta[name="description"]', "content", description);
  setMeta('meta[name="robots"]', "content", isAdmin || !page || pageSettings.indexable === false ? "noindex,nofollow" : "index,follow,max-image-preview:large");
    ...
    <Suspense fallback={<PageFallback />}>
      ...
      <Route element={<Protected />}>
        <Route path="/admin" element={<AdminLayout />}>
          ...
          <Route path="homepage" element={<ContentEditor section="homepage" />} />
          ...
          <Route path="process" element={<ContentEditor section="process" />} />
          <Route path="faq" element={<ContentEditor section="faq" />} />
          <Route path="testimonials" element={<ContentEditor section="testimonials" />} />
          <Route path="enquiries" element={<Enquiries />} />
          <Route path="settings" element={<Navigate to="website-settings" replace />} />
          <Route path="website-settings" element={<Settings section="website" />} />
          <Route path="navbar" element={<ContentEditor section="navbar" />} />
          <Route path="footer" element={<ContentEditor section="footer" />} />
          <Route path="contact-social" element={<ContentEditor section="contact" />} />
          <Route path="seo" element={<Settings section="seo" />} />
          <Route path="privacy" element={<ContentEditor section="privacy" />} />
